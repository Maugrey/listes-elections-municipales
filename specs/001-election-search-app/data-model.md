# Data Model: Portail de Recherche des Candidatures Municipales 2026
...
6. `Libellé abrégé` vide → `NULL` (pas de copie du libellé complet côté script, la logique
...
10. Fallback tête de liste (UPDATE)
